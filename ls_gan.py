...
# INF8225 - Projet
# Base sur : https://github.com/eriklindernoren/Keras-GAN/blob/master/lsgan/lsgan.py
...
# Implémentation d'un GAN avec un discriminateur utilisant la fonction de moindre carré
class LSGAN():
    def __init__(self):
        ...
        # Optimiser en respectant la fonction de perte des moindres carrés à la place de l'entropie croisée binaire
